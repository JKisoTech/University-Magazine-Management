...
namespace BusinessLogicLayer.Services.User
{
    public interface IUserServices
    {
        ...
        public Task<UserDTO> SetStatus(string _loginName, bool status);
        public Task<UserDTO> user_change_password(string _loginname, string _Oldpassword, string _Newpassword);
    }
}
